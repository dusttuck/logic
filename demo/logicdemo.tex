...
Dustin Tucker
\email{dustin.tucker\at colostate.edu}
\strut
...
\noindent\hfil\vbox\bgroup\halign{
	\hfil#&\quad\hfil\tt#\hfil&\qquad#\hfil&#\hfil\cr
	              &\bf Character&\bf Expression\cr
	\noalign{\medskip}
	@\connectives@&-&@\lnot@&(in math mode)\cr
	              &v&@\mathrel\lor@\cr
	              &\makecaretbetter^&@\mathrel\land@\cr
	              &>&@\rightarrow@\cr
	              &<&@\leftrightarrow@\cr
	              &!&@\bot@\cr
	              &=&@\mathbin=@\cr
...
\argumentlinethickness=1.6pt%  Thickness of the horizontal line
